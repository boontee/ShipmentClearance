...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "SubProcessRouting", name = "SubProcessRouting", hidden = false)
public class SubProcessRoutingModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<SubProcessRoutingModelOutput> {
    ...
    @Override()
    public SubProcessRoutingModelOutput toModel() {
        SubProcessRoutingModelOutput result = new SubProcessRoutingModelOutput();
        result.setId(getId());
