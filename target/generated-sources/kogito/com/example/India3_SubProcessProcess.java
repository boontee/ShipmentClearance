...
public class India3_SubProcessProcess extends org.kie.kogito.process.impl.AbstractProcess<com.example.India3_SubProcessModel> {

    public India3_SubProcessProcess(org.kie.kogito.app.Application app, org.kie.kogito.correlation.CorrelationService correlations) {
    ...
    public India3_SubProcessProcess(org.kie.kogito.app.Application app, org.kie.kogito.correlation.CorrelationService correlations, org.kie.kogito.handlers.CoffeeService_getCoffees__7E3702E2_0CF5_4EB1_AC1B_FD9175B9BF83_Handler coffeeService_getCoffees__7E3702E2_0CF5_4EB1_AC1B_FD9175B9BF83_Handler) {
        super(app, java.util.Arrays.asList(coffeeService_getCoffees__7E3702E2_0CF5_4EB1_AC1B_FD9175B9BF83_Handler), correlations);
        activate();
    }

    public India3_SubProcessProcess() {
    }

    @Override()
    public com.example.India3_SubProcessProcessInstance createInstance(com.example.India3_SubProcessModel value) {
        return new com.example.India3_SubProcessProcessInstance(this, value, this.createProcessRuntime());
    }

    public com.example.India3_SubProcessProcessInstance createInstance(java.lang.String businessKey, com.example.India3_SubProcessModel value) {
        return new com.example.India3_SubProcessProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    public com.example.India3_SubProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.correlation.CompositeCorrelation correlation, com.example.India3_SubProcessModel value) {
        return new com.example.India3_SubProcessProcessInstance(this, value, businessKey, this.createProcessRuntime(), correlation);
    }

    @Override()
    public com.example.India3_SubProcessModel createModel() {
        return new com.example.India3_SubProcessModel();
    }

    public com.example.India3_SubProcessProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((com.example.India3_SubProcessModel) value);
    }

    public com.example.India3_SubProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (com.example.India3_SubProcessModel) value);
    }

    public com.example.India3_SubProcessProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.example.India3_SubProcessProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public com.example.India3_SubProcessProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.example.India3_SubProcessProcessInstance(this, this.createModel(), wpi);
    }

    protected org.kie.api.definition.process.Process process() {
        RuleFlowProcessFactory factory = RuleFlowProcessFactory.createProcess("India3_SubProcess", true);
        ...
        factory.name("India3_SubProcess");
