...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "ShipmentClearanceStub", name = "ShipmentClearanceStub", hidden = false)
public class ShipmentClearanceStubModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ShipmentClearanceStubModelOutput> {
    ...
    @Override()
    public ShipmentClearanceStubModelOutput toModel() {
        ShipmentClearanceStubModelOutput result = new ShipmentClearanceStubModelOutput();
        result.setId(getId());
