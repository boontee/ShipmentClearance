...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "ProcessShipmentEvent", name = "ProcessShipmentEvent", hidden = true)
@ProcessInput(processName = "ProcessShipmentEvent")
public class ProcessShipmentEventModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<ProcessShipmentEventModel> {
    ...
    @org.kie.kogito.codegen.VariableInfo(tags = "")
    @com.fasterxml.jackson.annotation.JsonProperty(value = "shipment")
    @jakarta.validation.Valid()
    private org.acme.cc_approval.model.Shipment shipment;

    public org.acme.cc_approval.model.Shipment getShipment() {
        return shipment;
    }

    public void setShipment(org.acme.cc_approval.model.Shipment shipment) {
    ...
    @jakarta.validation.Valid()
    private org.acme.cc_approval.model.Traveller traveller;

    public org.acme.cc_approval.model.Traveller getTraveller() {
        return traveller;
    }

    public void setTraveller(org.acme.cc_approval.model.Traveller traveller) {
    ...
    @Override()
    public ProcessShipmentEventModel toModel() {
        ProcessShipmentEventModel result = new ProcessShipmentEventModel();
        result.setItem(getItem());
        result.setApproved(getApproved());
        result.setShipment(getShipment());
