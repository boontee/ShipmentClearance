...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "ProcessShipmentEvent", name = "ProcessShipmentEvent", hidden = false)
public class ProcessShipmentEventModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ProcessShipmentEventModelOutput> {
    ...
    @Override()
    public ProcessShipmentEventModelOutput toModel() {
        ProcessShipmentEventModelOutput result = new ProcessShipmentEventModelOutput();
        result.setId(getId());
