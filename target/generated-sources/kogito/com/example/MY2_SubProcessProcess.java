...
public class MY2_SubProcessProcess extends org.kie.kogito.process.impl.AbstractProcess<com.example.MY2_SubProcessModel> {

    @jakarta.inject.Inject()
    public MY2_SubProcessProcess(org.kie.kogito.app.Application app, org.kie.kogito.correlation.CorrelationService correlations) {
        super(app, java.util.Arrays.asList(), correlations);
        activate();
    }

    public MY2_SubProcessProcess() {
    }

    @Override()
    public com.example.MY2_SubProcessProcessInstance createInstance(com.example.MY2_SubProcessModel value) {
        return new com.example.MY2_SubProcessProcessInstance(this, value, this.createProcessRuntime());
    }

    public com.example.MY2_SubProcessProcessInstance createInstance(java.lang.String businessKey, com.example.MY2_SubProcessModel value) {
        return new com.example.MY2_SubProcessProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    public com.example.MY2_SubProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.correlation.CompositeCorrelation correlation, com.example.MY2_SubProcessModel value) {
        return new com.example.MY2_SubProcessProcessInstance(this, value, businessKey, this.createProcessRuntime(), correlation);
    }

    @Override()
    public com.example.MY2_SubProcessModel createModel() {
        return new com.example.MY2_SubProcessModel();
    }

    public com.example.MY2_SubProcessProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((com.example.MY2_SubProcessModel) value);
    }

    public com.example.MY2_SubProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (com.example.MY2_SubProcessModel) value);
    }

    public com.example.MY2_SubProcessProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.example.MY2_SubProcessProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public com.example.MY2_SubProcessProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new com.example.MY2_SubProcessProcessInstance(this, this.createModel(), wpi);
    }

    protected org.kie.api.definition.process.Process process() {
        RuleFlowProcessFactory factory = RuleFlowProcessFactory.createProcess("MY2_SubProcess", true);
