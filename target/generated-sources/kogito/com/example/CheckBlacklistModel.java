...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "CheckBlacklist", name = "CheckBlacklist", hidden = false)
public class CheckBlacklistModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<CheckBlacklistModelOutput> {
    ...
    @Override()
    public CheckBlacklistModelOutput toModel() {
        CheckBlacklistModelOutput result = new CheckBlacklistModelOutput();
        result.setId(getId());
