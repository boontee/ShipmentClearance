...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "ShipmentClearanceStub", name = "ShipmentClearanceStub", hidden = true)
@ProcessInput(processName = "ShipmentClearanceStub")
public class ShipmentClearanceStubModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<ShipmentClearanceStubModel> {
    ...
    @Override()
    public ShipmentClearanceStubModel toModel() {
        ShipmentClearanceStubModel result = new ShipmentClearanceStubModel();
