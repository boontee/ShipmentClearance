...
public class ShipmentClearance_TaskModelFactory {

    public static TaskModel from(org.kie.kogito.process.WorkItem workItem) {
        switch(workItem.getNodeId().toExternalFormat()) {
            case "_1A242378-7234-407F-ACB5-2EAD61B340E2":
                return ShipmentClearance__1A242378_7234_407F_ACB5_2EAD61B340E2_TaskModel.from(workItem);
            default:
