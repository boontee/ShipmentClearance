...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "SubProcessRouting", name = "SubProcessRouting", hidden = true)
@ProcessInput(processName = "SubProcessRouting")
public class SubProcessRoutingModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<SubProcessRoutingModel> {
    ...
    @org.kie.kogito.codegen.VariableInfo(tags = "")
    @com.fasterxml.jackson.annotation.JsonProperty(value = "subprocess")
    @jakarta.validation.Valid()
    ...
    @Override()
    public SubProcessRoutingModel toModel() {
        SubProcessRoutingModel result = new SubProcessRoutingModel();
        result.setItem(getItem());
        result.setApproved(getApproved());
        result.setReceiver(getReceiver());
        result.setSender(getSender());
        result.setSubprocess(getSubprocess());
        return result;
    }
}
