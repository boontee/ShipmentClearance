 ...
 * under the License.
 */
package https_58_47_47kie_46org_47dmn_47__9C335DB0_45F42D_454D60_45A6FC_453B4A33EB3346;
...
@Path("/SubProcess Routing Decision")
public class SubProcess_32Routing_32DecisionResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubProcessRoutingDecision.json#/definitions/InputSet")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubProcessRoutingDecision.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.org/dmn/_9C335DB0-F42D-4D60-A6FC-3B4A33EB3346", "SubProcess Routing Decision");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.org/dmn/_9C335DB0-F42D-4D60-A6FC-3B4A33EB3346", "SubProcess Routing Decision", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("SubProcess Routing Decision") + ".dmn_nologic")) {
